export var __ParticleCount = 2000;
var ParticleCountSlider = document.getElementById('slider3');
...
ParticleCountSlider.addEventListener("input", function () {
    __ParticleCount = Number(ParticleCountSlider === null || ParticleCountSlider === void 0 ? void 0 : ParticleCountSlider.value);
});
export var __abstractness = 0.8;
var AbstractnessSlider = document.getElementById('slider4');
if (!AbstractnessSlider) {
    throw new Error("Unable to get value of ParticleCountSlider");
}
AbstractnessSlider.addEventListener("input", function () {
    __abstractness = Number(AbstractnessSlider === null || AbstractnessSlider === void 0 ? void 0 : AbstractnessSlider.value);
});
export var __speed = 1;
var SpeedSlider = document.getElementById('slider5');
if (!SpeedSlider) {
    throw new Error("Unable to get value of SpeedSlider");
}
SpeedSlider.addEventListener("input", function () {
    __speed = Number(SpeedSlider === null || SpeedSlider === void 0 ? void 0 : SpeedSlider.value);
});
export var __colorValue = 0;
var colorValueSlider = document.getElementById('slider6');
if (!colorValueSlider) {
...
export var ColorPalettes = [
    ...
    ['#C7B198', '#9C7647', '#825E3A', '#533D32', '#3C2F2F'],
    ['#FFD1DC', '#FFB6C1', '#FFA07A', '#ADD8E6', '#B0E0E6'],
    ['#0077be', '#0087b3', '#3ea6cf', '#5b9bd5', '#4c4c4c'],
    ['#F5B041', '#F5AB35', '#F4D03F', '#F9E79F', '#FAD7A0'],
    ['#8B4513', '#D2691E', '#8F9779', '#556B2F', '#CD853F'],
    ['#800080', '#4B0082', '#7B3F00', '#008080', '#FF00FF'],
